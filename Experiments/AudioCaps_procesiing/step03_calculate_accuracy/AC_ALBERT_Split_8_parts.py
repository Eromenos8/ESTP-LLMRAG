...
class AudioCapsMatcher:
    ...
    def plot_accuracy_comparison(self, all_accuracies: List[List[float]], output_dir: str):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'accuracy_comparison_8parts.png'), 
...
def main():
    ...
    output_dir = "/root/autodl-tmp/AudioCaps/ALBERT_matched_result_8parts" 
