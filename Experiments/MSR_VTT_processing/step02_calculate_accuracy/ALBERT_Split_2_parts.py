...
class MultiPartALBERTAnalyzer:
    ...
    def split_datasets(self, df: pd.DataFrame, video_text_map: Dict[str, str], 
        ...
        # Split dataset into multiple parts ensuring each part contains matching text pairs
        #
        # Args:
        #   df: Original DataFrame
        #   video_text_map: Original video-text mapping
        #   num_parts: Number of parts to split into
        #   random_state: Random seed
        #
        # Returns:
        #   (part_video_text_maps, part_dfs)
    ...
    def analyze_matching_pairs(self, video_text_map: Dict[str, str], 
        ...
        # Analyze statistics of matching pairs
    ...
    def plot_multipart_accuracy_curve(self, all_accuracies: List[List[float]], 
                                    ...
                                    output_path: str):
        # Plot accuracy comparison curves for multiple parts of data
    ...
    def analyze_queries(self, data_dir: str, num_parts: int = 2):
        # Analyze multiple parts of data and compare results
...
def main():
    ...
    # Run analysis
    num_parts = 2  # Can be modified to 2, 4, 8 etc
